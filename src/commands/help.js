exports.run = (msg, bot, args) => {
    ...
    if (args.length === 0 || args[0] === "1") {
        ...
        help.addField(";resign", "For anyone in a governmental position to resign from their positions.");
        ...
        if (args[0] === "nominate") {
            ...
            help.addField("Extra notes", "If you nominate someone for Congress, you must choose House or Senate. Have about 9 House members per Senator.");
            ...
            help.addField("Example:", ";detain @nigward#6969 3 // Detains member 'nigward#6969', which can be approved by a judge.");
            ...
            help.addField("Extra notes", "Due to node.js complications, the Client() object is killed, and the process as well, thus it's impossible to fully \"reset\" the bot. Don't use this without my permission or notifying me beforehand, because I will usually just ctrl+C that shit outta here");
